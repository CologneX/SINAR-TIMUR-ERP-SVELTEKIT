<script lang="ts">
	...
	const storeTab: Writable<string> = writable('Penjualan');
	...
	dataTableStore.subscribe((carts) => dataTableHandler(carts));
	...
	function triggerConfirm(): void {
		const confirm: ModalSettings = {
			...
			body: 'Apakah anda mau menghapus Transaksi?',
...
<svelte:head>
	<title>Transaksi | SINAR TIMUR SORONG</title>
</svelte:head>
...
<div class="table-container p-8 ">
	...
	<GradientHeading
		...
		to="to-secondary-500"
		class="mb-2">Transaksi {$storeTab}</GradientHeading
	>

	<TabGroup selected={storeTab} class="justify-center">
		<Tab value="Penjualan">Penjualan</Tab>
		<Tab value="Pembelian">Pembelian</Tab>
	</TabGroup>

	<!-- Conditionally display content -->
	{#if $storeTab === 'Penjualan'}
		...
		<table class="table table-hover" use:tableInteraction>
			...
			>
				<tr>
					...
					<th data-sort="userId">Nama</th>
					<th data-sort="total">Total Harga</th>
					<th />
				</tr>
			</thead>
			<tbody>
